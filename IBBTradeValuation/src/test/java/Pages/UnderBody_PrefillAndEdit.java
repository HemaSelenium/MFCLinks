 ...
 *
 */
public class UnderBody_PrefillAndEdit {
	...
	public void underBodyFlooring(AndroidDriver<MobileElement> driver, String underBodyFlooring) throws Exception {
		...
		helper.selectMulti_aftersubmit(driver, underBodyFlooring);
		try {
			if (AppiumHelper.FindElementByXpath(driver, underbodyflooring).isDisplayed()) {
				System.out.println("After Edited underbodyflooring, Tick mark  displayed");
			}
		} catch (NoSuchElementException e) {
			System.out.println("After Edited underbodyflooring, Tick mark didnt display");
		}
	}
	...
	public void steeringSystem(AndroidDriver<MobileElement> driver, String SteeringSystem) throws Exception {
		...
		helper.selectMulti_aftersubmit(driver, SteeringSystem);
		try {
			if (AppiumHelper.FindElementByXpath(driver, steeringsystem).isDisplayed()) {
				System.out.println("After Edited steeringsystem, Tick mark  displayed");
			}
		} catch (NoSuchElementException e) {
			System.out.println("After Edited steeringsystem, Tick mark didnt display");
		}
	}
	...
	public void underBodyfrontimage(AndroidDriver<MobileElement> driver) throws Exception {
		...
		try {
			if (AppiumHelper.FindElementByXpath(driver, underbodyfrontimage).isDisplayed()) {
				System.out.println("After Edited underbodyfrontimage, Tick mark  displayed");
			}
		} catch (NoSuchElementException e) {
			System.out.println("After Edited underbodyfrontimage, Tick mark didnt display");
		}
	}
	...
	public void underBodyrearimage(AndroidDriver<MobileElement> driver) throws Exception {
		...
		try {
			if (AppiumHelper.FindElementByXpath(driver, underBodyrearimage).isDisplayed()) {
				System.out.println("After Edited underBodyrearimage, Tick mark  displayed");
			}
		} catch (NoSuchElementException e) {
			System.out.println("After Edited underBodyrearimage, Tick mark didnt display");
		}
	}
	...
	public void suspensionSystem(AndroidDriver<MobileElement> driver, String suspensionsystem) throws Exception {
		...
		helper.selectMulti_aftersubmit(driver, suspensionsystem);
		try {
			if (AppiumHelper.FindElementByXpath(driver, suspensionSystem).isDisplayed()) {
				System.out.println("After Edited suspensionSystem, Tick mark  displayed");
			}
		} catch (NoSuchElementException e) {
			System.out.println("After Edited suspensionSystem, Tick mark didnt display");
		}
	}
	public void transmissionAndBrakes(AndroidDriver<MobileElement> driver, String transmissionAndBrakes) throws Exception {
		...
		helper.selectMulti_aftersubmit(driver, transmissionAndBrakes);
		try {
			if (AppiumHelper.FindElementByXpath(driver, transmissionandbrakes).isDisplayed()) {
				System.out.println("After Edited transmissionandbrakes, Tick mark  displayed");
			}
		} catch (NoSuchElementException e) {
			System.out.println("After Edited transmissionandbrakes, Tick mark didnt display");
		}
	}
	public void fuelAndemission(AndroidDriver<MobileElement> driver, String FuelAndEmission) throws Exception {
			...
			helper.clickOnElementByXpath(driver, fuelandemission);
				helper.selectMulti_aftersubmit(driver, FuelAndEmission);
				try {
					if (AppiumHelper.FindElementByXpath(driver, fuelandemission).isDisplayed()) {
						System.out.println("After Edited fuelandemission, Tick mark  displayed");
					}
				} catch (NoSuchElementException e) {
					System.out.println("After Edited fuelandemission, Tick mark didnt display");
				}
		}
	public void mufler(AndroidDriver<MobileElement> driver, String Muffler) throws Exception {
		...
		helper.selectMulti_aftersubmit(driver, Muffler);
		try {
			if (AppiumHelper.FindElementByXpath(driver, muffler).isDisplayed()) {
				System.out.println("After Edited muffler, Tick mark  displayed");
			}
		} catch (NoSuchElementException e) {
			System.out.println("After Edited muffler, Tick mark didnt display");
		}
	}
