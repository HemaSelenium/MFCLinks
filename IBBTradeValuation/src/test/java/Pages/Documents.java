...
public class Documents {
	...
	public static String SubmitAll="com.mahindra.ibbtrade_pro:id/submitAll";
		...
		try {
			...
			try {
				if(AppiumHelper.FindElementByXpath(driver, RC_tick).isDisplayed()) {
					System.out.println("After filled RC field, Tick mark  displayed");
				}
			}
			catch(NoSuchElementException e) {
				System.out.println("After filled RC field, Tick mark didnt display");
			}
	...
	public void RCfrontcopyimage(AndroidDriver<MobileElement> driver) throws Exception {
		...
		try {
			if(AppiumHelper.FindElementByXpath(driver, RCFrontCopy_tick).isDisplayed()) {
				System.out.println("After captured RCfrontcopyimage, Tick mark  displayed");
			}
		}
		catch(NoSuchElementException e) {
			System.out.println("After captured RCfrontcopyimage, Tick mark didnt display");
		}
	}
	...
	public void RCBackCopyimage(AndroidDriver<MobileElement> driver) throws Exception {
		...
		try {
			if(AppiumHelper.FindElementByXpath(driver, RCBackcopy_tick).isDisplayed()) {
				System.out.println("After captured RCBackCopyimage, Tick mark  displayed");
			}
		}
		catch(NoSuchElementException e) {
			System.out.println("After captured RCBackCopyimage, Tick mark didnt display");
		}
	}
		...
		try {
			...
			try {
				if(AppiumHelper.FindElementByXpath(driver, Insurance_tick).isDisplayed()) {
					System.out.println("After filled Insurance field, Tick mark  displayed");
				}
			}
			catch(NoSuchElementException e) {
				System.out.println("After filled Insurance field, Tick mark didnt display");
			}
		...
		try {
			...
			try {
				if(AppiumHelper.FindElementByXpath(driver, InsuranceCopyImages_tick).isDisplayed()) {
					System.out.println("After captured Insurancecopyimage, Tick mark  displayed");
				}
			}
			catch(NoSuchElementException k) {
				System.out.println("After captured Insurancecopyimage, Tick mark didnt display");
			}
		}
	}
	...
	public void insuranceCompany(AndroidDriver<MobileElement> driver,String insurancecompany) throws Exception {
		try {
			...
			if (AppiumHelper
				...
				System.out.println("Insurancecompany Value is not prefilled");
			}
			else {
				System.out.println("Insurancecompany Value is prefilled");
			}
			helper.clickOnElementByXpath(driver, "//android.widget.TextView[@text='Insurance Company']");
			helper.ScrollToViewElement(driver, insurancecompany);
			helper.clickOnElementByXpath(driver, "//android.widget.TextView[@text='"+insurancecompany+"']");
			try {
				if(AppiumHelper.FindElementByXpath(driver, Insurancecompany_tick).isDisplayed()) {
					System.out.println("After filled the  Insurancecompany field, Tick mark  displayed");
				}
			}
			catch(NoSuchElementException k) {
				System.out.println("After filled the  Insurancecompany field, Tick mark didnt display");
			}
		...
		try {
			...
			if (AppiumHelper
					...
					.FindElementByXpath(driver,
							InsuranceIDV)
					.getText().equals("--select--")) {
				System.out.println("InsuranceIDV Value is not prefilled");
			}
			else {
				System.out.println("InsuranceIDV Value is prefilled");
			}
	...
	public void hypothecatedbank(AndroidDriver<MobileElement> driver, String hypothecatedbank) throws Exception {
		...
		try {
			if(AppiumHelper.FindElementByXpath(driver, Hypothecationbank_tick).isDisplayed()) {
				System.out.println("After fill the hypothecatedbank details, Tick mark  displayed");
			}
		}
		catch(NoSuchElementException e) {
			System.out.println("After fill the hypothecatedbank details, Tick mark didnt display");
		}
	}
	...
	public void hypothecation(AndroidDriver<MobileElement> driver, String hypothecation) throws Exception {
		...
		try {
			if(AppiumHelper.FindElementByXpath(driver, Hypothecation_tick).isDisplayed()) {
				System.out.println("After fill the Hypothecation field details, Tick mark  displayed");
			}
		}
		catch(NoSuchElementException k) {
			System.out.println("After fill the hypothecationClosed field details, Tick mark didnt display");
		}
	}
	...
	public void hypothecationClosed(AndroidDriver<MobileElement> driver, String hypothecationclosed) throws Exception {
		...
		try {
			if(AppiumHelper.FindElementByXpath(driver, hypothecationClosed_tick).isDisplayed()) {
				System.out.println("After fill the hypothecationClosed field details, Tick mark  displayed");
			}
		}
		catch(NoSuchElementException k) {
			System.out.println("After fill the hypothecationClosed field details, Tick mark didnt display");
	...
	public void Nocavaialble(AndroidDriver<MobileElement> driver, String nocAvailable) throws Exception {
		...
		try {
			if(AppiumHelper.FindElementByXpath(driver, Nocavaialble_tick).isDisplayed()) {
				System.out.println("After fill the Nocavaialble field, Tick mark  displayed");
			}
		}
		catch(NoSuchElementException k) {
			System.out.println("After fill the Nocavaialble field, Tick mark didnt display");
		}
	}
	...
	public void NocImage(AndroidDriver<MobileElement> driver) throws Exception {
		...
		try {
			if(AppiumHelper.FindElementByXpath(driver, NOCImages_tick).isDisplayed()) {
				System.out.println("After fill NocImage field, Tick mark  displayed");
			}
		}
		catch(NoSuchElementException e) {
			System.out.println("After fill NocImage field, Tick mark didnt display");
		}
	}
		...
		try {
			...
			if (AppiumHelper
					...
					.FindElementByXpath(driver,
							"//android.widget.TextView[@text='Form 35 Available*']//following-sibling::android.widget.EditText")
					.getText().equals("--select--")) {
				System.out.println("Form35Available Value is not prefilled");
			}
			else {
				System.out.println("Form35Available Value is prefilled");
			}
	...
	helper.clickOnDone(driver);
		...
		try {
			if(AppiumHelper.FindElementByXpath(driver, form35images_tick).isDisplayed()) {
				System.out.println("After Captured Form35images, Tick mark  displayed");
			}
		}
		catch(NoSuchElementException l) {
			System.out.println("After Captured Form35images, Tick mark didnt display");
		}
	...
	public void Duplicatekey(AndroidDriver<MobileElement> driver,String duplicatekey) throws Exception {
		...
		try {
			if(AppiumHelper.FindElementByXpath(driver, DuplicateKey_tick).isDisplayed()) {
				System.out.println("After fill the DuplicateKey field, Tick mark  displayed");
			}
		}
		catch(NoSuchElementException k) {
			System.out.println("After fill the DuplicateKey field, Tick mark didnt display");
		}
	}
}
